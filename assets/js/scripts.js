...
(function() {
    ...
    const accordion = document.querySelector(".js-sidebar-menu");
    let sections = [];
    ...
    for (let i = 0; i < sections.length; i++) {
        (function() {
            ...
            const anchor = section.children[0];
            const below = section.children[1]; 
...
(function () {
	// share popup
	const shareButton = document.querySelector('.content__share-button');
	const sharePopup = document.querySelector('.content__share-popup');
